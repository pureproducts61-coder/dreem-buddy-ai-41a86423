...
const Login = () => {
  ...
  return (
    <div className="relative flex min-h-[100dvh] items-center justify-center bg-background overflow-hidden">
      {/* Subtle background */}
      <div className="pointer-events-none fixed inset-0 subtle-grid opacity-40" />
      ...
      {/* Status */}
      <motion.div
        className="absolute left-4 top-4 z-20 flex items-center gap-2 rounded-full border border-border/50 bg-card/60 backdrop-blur-lg px-3 py-1.5"
      ...
      >
        ...
        >
          ...
          <form onSubmit={handleConnect} className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="backendUrl" className="text-xs text-muted-foreground">
                {t('login.backendUrl')}
              </Label>
              <Input
                id="backendUrl"
            ...
            <div className="space-y-2">
              <Label htmlFor="masterSecret" className="text-xs text-muted-foreground">
        ...
        <motion.p
          className="mt-8 text-center text-[11px] text-muted-foreground/40"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
